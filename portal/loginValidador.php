...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center flex-grow-1">
        <div class="container-custom text-center" data-aos="zoom-in">
            <h2 class="mb-5 text-warning">Iniciar Sesión como Validador</h2>
                    ...
                    <?php
                        switch ($_GET['error']) {
                            ...
                            case 'usuario_incorrecto':
                                ...
                                break;
                            case 'no_validador':
                                echo "El usuario no tiene permisos de validador.";
                                break;
                            default:
            ...
            <form action="iniciarSesionValidador.php" method="post">
